...
9.  그래픽과 일러스트레이션이 결합된 실제 이미지<br>
    (Real Images Combined with Graphics and Illustration)

    <img src="img/real-image-graphic-illust.png" width="400px">

          이미지를 돋보이게 하기 위해 일러스트와 그래픽을 오버레이하여
          장난스럽고 활동적인 느낌을 줌

10.   인터랙티브 콘텐츠 (Interactive Content)
  <img src="img/interactive-content.png" width="400px">
